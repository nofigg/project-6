...
const RedesigningFintechDashboard = () => {
  return (
    <div className="prose-lg font-ibm-plex-sans">
      <section>
        <p className="mb-6">
          When I was approached to redesign a financial trading platform's dashboard, I knew the
          challenge would be balancing complexity with usability. The existing dashboard was
          powerful but overwhelming, leading to user frustration and decreased productivity.
        </p>
        ...
        <p>
          This project reinforced the importance of user research and iterative design in creating
